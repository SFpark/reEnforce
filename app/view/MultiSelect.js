// http://www.sencha.com/forum/showthread.php?181809-New-quot-Multi-select-field-quot-extension-for-ST2-(RC)
Ext.define('SFenforce.view.MultiSelect', {
    ...
    onListHide: function(cmp, opts) {
        var me = this,
            recordArray = this.listPanel.down('list').getSelection(),
